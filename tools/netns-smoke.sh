...
set -e
PW="REDACTED"
BIN=/home/<SSH_USER>/great-hole/build/src/great-hole
...
c=m:create_channel('<RS_PSK>','192.168.100.2',22556)
t=hole.tun('fec-a')
...
c=m:create_channel('<RS_PSK>','192.168.100.1',22555)
t=hole.tun('fec-b')
...
# iperf3 UDP
sudo ip netns exec fecns sudo -u <SSH_USER> iperf3 -s -1 -B 10.100.1.2 &>/dev/null &
sleep 0.5
