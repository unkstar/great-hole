-- Ali side: TEST-ONLY FEC tunnel to Tokyo (port 20086, direct UDP, no speederv2)
-- Production nested tunnel uses 10086/10087 — do not touch.
-- great-hole-fec --startlua /etc/great-hole/fec/fec-test-ali.lua

local tokyo_ip = '202.144.195.103'
local test_port = 20086

m = hole.udp_dyn_mux(test_port)
c = m:create_channel("0123456789abcdef", tokyo_ip, test_port)
...
print("Ali FEC-test tokyo started on port " .. test_port .. " (PI algo, overhead=1% base)")
