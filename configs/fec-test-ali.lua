-- Ali side: TEST-ONLY RS FEC tunnel, direct UDP (no dyn_mux negotiation)
local peer_ip = '202.144.195.103'
...
print("Ali RS FEC-test direct UDP started, peer " .. peer_ip .. ":" .. test_port)
